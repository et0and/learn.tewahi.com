...
Operating the lasercutting and engraving machine requires specialist knowledge. While this page provides a good guide for all the steps you need to take, be sure to talk to Mr. Kydd or Mr. Hackshaw if you are operating the machine for the very first time. Inproper use of the machine can result in injury, fires, or worse, so play it safe!
</Callout>
...
![Computer in Te Wāhi to use](https://media.tewahi.com/cut5.png)
...
![GIF drag and drop onto Illustrator](https://media.tewahi.com/cut7.gif)
